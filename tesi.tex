...
\input{2_descrizione_stage.tex}             % Kick-Off
\input{3_0_analisi_dei_requisiti.tex}             % Concept Preview
\input{4_0_progettazione_codifica.tex}             % Product Prototype
\input{5_verifica_validazione.tex}             % Product Design Freeze e SOP
\input{6_0_conclusioni.tex}             % Conclusioni
\appendix

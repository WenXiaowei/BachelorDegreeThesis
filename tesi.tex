...
\input{./capitoli/2_descrizione_stage.tex}             % Kick-Off
\input{./capitoli/3_0_analisi_dei_requisiti.tex}             % Concept Preview
\input{./capitoli/4_0_progettazione_codifica.tex}             % Product Prototype
\input{./capitoli/5_verifica_validazione.tex}             % Product Design Freeze e SOP
\input{./capitoli/6_0_conclusioni.tex}             % Conclusioni
\appendix

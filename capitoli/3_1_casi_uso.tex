...
\begin{itemize}
    ...
    \item \textbf{flusso degli eventi principali:}
    \begin{itemize}
        \item l'utente selezionare l'opzione di elencare i file analizzati.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{flusso degli eventi principali:}
    \begin{itemize}
        \item l'utente seleziona il file path verso il file di blacklist.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{flusso degli eventi principali:}
    \begin{itemize}
        \item l'utente seleziona il file path verso il file di whitelist.
    \end{itemize}
\end{itemize}

...
\begin{longtable}{ | C{1.5cm} |C{2cm} |C{7cm} |C{1.5cm}|}
    \hline
    \textbf{ID} &
    \textbf{Requisito} &
    \textbf{Descrizione} &
    ...
    \idTest{TS} & R-8.1-F-O  & Verificare che venga visualizzato il messaggio quando la decodifica dei file dex è avvenuta con successo.& I \\\hline

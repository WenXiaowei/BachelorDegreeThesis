...
La terza e la quarta applicazione sono due versioni dello stesso progetto messo a disposizione da \gls{android_studio} con l'unica differenza del linguaggio di programmazione utilizzato, con la differenza di circa \textit{15.58\%}, questa differenza è dovuta ai tool esterni che il APAT utilizza, per cui non è stato possibile migliorare la prestazione da questo punto di vista.
...
\begin{longtable}{| C{3cm}|C{7cm} |C{3cm}|}
    ...
    & Completato \\\hline
    R-1-V-D            & Il tool può essere un tool da righe di comando.
    & Non Completatoc\\\hline
    R-2-V-D            & Il tool può essere un tool dotato di GUI.
    & Completato\\\hline
    R-3-V-D            & Il tool può essere sviluppato in JAVA.
    & Completato\\\hline
    R-4-V-F            & Il tool può essere sviluppato utilizzando i linguaggi funzionali.
    & Completato\\\hline
    R-1-Q-O            & Il codice sorgente deve essere versionato col sistema di versionamento dell’azienda ospitante.
    & Completato\\\hline
    R-2-Q-O            & Il codice sorgente deve essere sotto licenza GPLv3.
    & Completato\\\hline
    R-3-Q-O            & Il code coverage dei test unitari deve superare 80\%.
    & Completato\\\hline
    R-4-Q-O            & Il code coverage dei test unitari deve essere 90\%.
    & Completato\\\hline

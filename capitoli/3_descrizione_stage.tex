...
\begin{enumerate}
    ...
    \item eseguire l'analisi del codice sorgente e dei file ottenuti dal passo 3 e infine estrarre i dati dai file di database, generando, al termine dell'operazione di analisi, un file di resoconto con i risultati dell'analisi.
\end{enumerate}
%**************************************************************

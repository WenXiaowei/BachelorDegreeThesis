...
\begin{itemize}
    ...
    \item \textit{Deployment \& Maintenance:} si tratta di messa in produzione del software sviluppato, quindi bisogna effettuare l'analisi della sicurezza e quindi configurare sia software che l'hardware sul quale è in esecuzione in modo corretto.
\end{itemize}

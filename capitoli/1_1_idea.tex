...
La sicurezza è diventata pertanto un fattore critico sulle piattaforme mobile: se tradizionalmente la sicurezza di un sistema viene declinata secondo la cosiddetta triade CIA\footcite{samonas2014cia}, ovvero dalla Confidenzialità, Integrità e Disponibilità (dall'inglese Availability) di un sistema;
sulle piattaforme mobile garantire il rispetto di queste proprietà è assai più complesso rispetto ai sistemi tradizionali, per via della loro eterogeneità, diffusione e distribuzione, da cui è necessario ripensare alla sicurezza dei sistemi per garantire la protezione degli utenti, delle loro risorse e delle piattaforme.
...
\begin{itemize}
    ...
    \item \textit{Deployment e Maintenance:} si tratta di messa in produzione del software sviluppato, quindi bisogna effettuare l'analisi della sicurezza e quindi configurare sia software che l'hardware sul quale è in esecuzione in modo corretto.
\end{itemize}

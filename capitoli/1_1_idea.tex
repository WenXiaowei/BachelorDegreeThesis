...
\begin{itemize}
    ...
    \item \textit{Client code quality:} include entità che possono trasmettere input non attendibili alle chiamate di metodo effettuate all'interno del codice mobile.

...
Essendo il progetto finalizzato alla creazione di un tool per l'automazione di un processo di decompilazione di un file APK, di trasformazione dei file decompilati (\gls{dex}) in codice java e dell'analisi di quest'ultimo.
}\\
...
\input{./capitoli/4_1_casi_uso.tex}
\input{./capitoli/4_2_requisiti.tex}
\input{./capitoli/4_3_tracciamento_requisiti.tex}

...
\begin{longtable}{|C{3cm}|C{8cm}|C{2cm}|}
    ...
    \begin{itemize}%\itemsep0em
        \item progettazione della logica per la creazione dei comandi;
    ...
    \begin{itemize}%\itemsep0em
        \item codifica della logica per la creazione dei comandi;
...
La pianificazione è stata svolta in maniera sufficientemente precisa.
In questo modo, le attività sono state svolte nei tempi previsti della durata dello stage.
Nonostante si fossero presentate alcune difficoltà il lavoro non ha subito gravi ritardi grazie all'aiuto del tutor aziendale.

...
\begin{longtable}{ |C{3cm} | C{8.5cm}| C{1.5cm} |}
    ...
    & I \\\hline
    \idTest{TU} & Verificare che l'elenco dei file presenti nella cartella ./tmp sia corretto.
    & I \\\hline
    ...
    & I \\\hline
    \idTest{TU} & Verificare che il signing dell'APK ricompilato avvenga correttamente.
    & I \\\hline
    ...
    & I \\\hline
    \idTest{TU} & Verificare che i paragrafi vengano inseriti nel pdf correttamente.
    & I \\\hline
    \idTest{TU} & Verificare che il file zip venga estratto correttamente.
    & I \\\hline
    \idTest{TU} & Verificare che il paragrafo generato sia corretto rispetto all'elenco dei file dato.
    & I \\\hline
    \idTest{TU} & Verificare che il paragrafo generato sia corretto rispetto all'elenco dei file dato.
    & I \\\hline
    \idTest{TU} & Verificare che il paragrafo generato sia corretto rispetto all'elenco dei file dato.
    ...
    \idTest{TU} & Verificare che il paragrafo generato sia corretto rispetto all'elenco dei file dato.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per decompilare l'APK sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per ricompilare l'APK sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per firmare l'APK ricompilato sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per ottenere l'elenco delle AVD sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per avviare l'AVD sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per installare l'APK sull'AVD sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per scaricare l'area di storage dell'app installato sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per convertire i file .class in .java sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per rimuovere i file decompilati sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per connettersi all'AVD come root sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per connettersi all'AVD normalmente sia corretto.
    & I \\\hline
    \idTest{TU} & Verificare che il comando generato per ottenere i parametri del terminale sia corretto.
    & I \\\hline
    ...
    & I \\\hline
    \idTest{TU} & Verificare che vengano accettati solo i file di tipo JKS.
    & I \\\hline
    \idTest{TU} & Verificare che la descrizione restituita sia corretta.
    & I \\\hline

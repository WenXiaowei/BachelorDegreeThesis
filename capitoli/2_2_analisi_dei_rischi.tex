...
\begin{risk}{Tecnologie/framework sconosciute}
    \riskdescription{Durante lo svolgimento dello stage, è l'uso di alcune tecnologie o di framework finora mai viste dallo stagista.}
...
\begin{risk}{Incomprensioni o scelte non ottimali}
    \riskdescription{A causa dell'inesperienza può accadere che le attività da svolgere siano fraintese o valutate erroneamente, causando la realizzazione di un prodotto non consono alle aspettative dell'azienda}

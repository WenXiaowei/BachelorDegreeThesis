...
\begin{center}
    \begin{longtable}{ | c| C{7cm} |C{3cm} |}
        \hline
        \textbf{Identificativo} & \textbf{Descrizione} &\textbf{Fonte}\\\hline
        \idRequesiti{V-D} &Il tool può essere un tool da righe di commando & Piano di lavoro.\\\hline
        \idRequesiti{V-D} &Il tool può essere un tool dotato di GUI & Piano di lavoro.\\\hline
        \idRequesiti{V-D} &Il tool può essere sviluppato in JAVA & Piano di lavoro.\\\hline
        \idRequesiti{V-F} &Il tool può essere sviluppato utilizzando i linguaggi funzionali.& Piano di lavoro.\\\hline
...
\begin{center}
    \begin{longtable}{ | c| C{7cm} |C{3cm} |}
        \hline
        \textbf{Identificativo} & \textbf{Descrizione} &\textbf{Fonte}\\\hline
        \idRequesiti{Q-O}&Il codice sorgente deve essere versionato col sistema di versionamento dell'azienda ospitante. &Piano di lavoro \\\hline
        \idRequesiti{Q-O}&Il Il codice sorgente deve essere sotto licenza GPL v3.& Piano di lavoro\\\hline
%        \idRequesiti{Q-O}&Il code coverage dei test unitari deve superare 80\%.& Piano di lavoro\\\hline
%        \idRequesiti{Q-D}&Il code coverage dei test unitari deve essere 100\%.& Piano di lavoro\\\hline

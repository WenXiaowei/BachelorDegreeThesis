...
Questi strumenti sono spesso costruiti assemblando componenti di terze parti o open-source, integrate con codice con il codice originale\cite{site:sca}}
}
%**************************************************************
...
sort= sast,
description={Static Application Security Testing\cite{site:sast} è una tecnologia che è frequentemente utilizzata come un tool di analisi del codice sorgente.
...
description={è una tecnica di analisi delle funzioni, degli impieghi, della collocazione, dell'aspetto progettuale, geometrico e materiale di un manufatto o di un oggetto che è stato rivenuto.
